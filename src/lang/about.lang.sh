...
readonly L_ABOUT_AUTHORS="Florian Kemser and the CUPSwrapper contributors"
...
#  '.' out.
readonly L_ABOUT_DESCRIPTION="a collection of shell scripts to interactively print and manage printers for local usage"
...
readonly L_ABOUT_PROJECT="CUPSwrapper"
